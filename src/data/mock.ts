export const PROFILE = {
  ...
  experience: "3 Years",
  bio: "Full Stack Developer with 3+ years of experience building enterprise-grade web and mobile applications. I specialize in Next.js, TypeScript, Node.js, and React, with a proven track record of architecting scalable systems for platforms serving millions of users — including several West Bengal government portals. Based in Kolkata, India.",
...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    date: "October 2025",
    description: "High-traffic mobile companion for Bengal’s biggest festival with 1L+ downloads and real-time navigation.",
    detailedStory: "Developed for the Kolkata Police to manage millions of visitors during Durga Puja. The app features real-time pandal crowd updates, emergency SOS buttons, and GPS-based route maps. It maintained 99.9% uptime during the 5-day peak period with over 1L+ active users.",
